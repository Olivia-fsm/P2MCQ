    ...
    def _fast_translate_batch(self,
        ...
        for step in range(max_length):
            ...
            if is_finished.any():
                ...
                topk_log_probs = topk_log_probs.index_select(0, non_finished.long())
                batch_index = batch_index.index_select(0, non_finished.long())
                batch_offset = batch_offset.index_select(0, non_finished.long())
                alive_seq = predictions.index_select(0, non_finished.long()) \
